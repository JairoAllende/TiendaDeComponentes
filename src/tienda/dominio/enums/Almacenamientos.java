...
public enum Almacenamientos {
    ...
    DISCO_RIGIDO_1TB_ADATA(true, "Rigido", "Adata", 1000, 2000, 1800, "USB 3.1", 90000d),
    DISCO_SOLIDO_2TB_ADATA(true, "Solido", "Adata", 2000, 3000, 2000, "USB 3.2", 225800d),
    DISCO_RIGIDO_2TB_SEAGATE(false, "Rigido", "Seagate", 2000, 1000, 500, "SATA", 83000d),
    DISCO_SOLIDO_256G_TEAM(false, "Solido", "Team", 256, 520, 430, "SATA", 25000d),
    DISCO_SOLIDO_1TB_WESTERNDIGITAL(false, "Rigido", "Western Digital", 1000, 2400, 1850, "NVMe", 71000d),
    ;
    ...
    Almacenamientos(Boolean ES_EXTERNO , String TIPO, String MARCA, Integer CAPACIDAD_GIGAS, Integer VELOCIDAD_LECTURA,Integer VELOCIDAD_ESCRITURA, String TIPO_DE_CONEXION, Double PRECIO) {
